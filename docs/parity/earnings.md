...
> card with 3.87 USDC waiting; its remove confirmation opens with Remove disabled) and
> `URNETWORK_PREVIEW_USDC_WAITING=1` (the line, no wallet) extend the sample.
